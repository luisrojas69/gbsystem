    ...
    <div class="box box-primary">
      <div class="box-body box-profile">
        ...
        <ul class="nav nav-stacked">
          ...
          <li><a href="#">Fecha de Ingreso <span class="pull-right badge bg-red">{{ Carbon\Carbon::parse($animal->date_in)->format('d-m-Y') }}</span></a></li>
          <li><a href="#">Ultimo Pesaje <span class="pull-right badge bg-purple">{{ $weight }} Kgs</span></a></li>
          <li><a href="#">Ganancia Total de Peso <span class="pull-right badge bg-purple">{{ ($weight - $animal->weight_in) }} Kgs</span></a></li>
          <li><a href="#">Cantidad de Pesajes<span class="pull-right badge bg-orange">{{ $animal->numWeighings + 1}}</span></a></li>
          <li><a href="#">Peso al Ingresar<span class="pull-right badge bg-aqua">{{ $animal->weight_in }} Kgs</span></a></li>

          <li><a href="#">Fecha del Ultimo Pesaje <span class="pull-right badge bg-purple">{{  Carbon\Carbon::parse($last_date)->format('d-m-Y') }}</span></a></li>
