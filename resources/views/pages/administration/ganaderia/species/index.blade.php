...
<div class="box">
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                        <a href="javascript:void(0)"
                            ...
                            document.getElementById('form-edit-{{ $specie->id }}').submit()">
                             <span class="label label-primary"><i class="fa fa-pencil"></i></span>
                        </a>

                        <form method="GET"
                            action="{{ route('specie.edit', $specie) }}"
                            id="form-edit-{{ $specie->id }}"
                            style="display: none;">
                            {{ csrf_field() }}
                        </form>
            ...
            <div class="box-footer clearfix">
               <a class="btn btn-primary no-margin pull-right"
                                title="Crear un nueva Especie"
                                href="{{ route('specie.create') }}">
