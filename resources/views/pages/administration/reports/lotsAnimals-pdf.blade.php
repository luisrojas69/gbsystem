      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <thead>	
          <tr>
            ...
            <th class="unit">Fecha IN</th>
            <th class="total">Num. Animals</th>
          </tr>
        </thead>
        <tbody>
        ...
        @foreach($lotsAnimals as $lotAnimal)
          <tr>
            <td class="no">{{ $lotAnimal->lot_co }}</td>
            <td class="desc"><h3>{{ $lotAnimal->lot_de }}</h3>Observaciones: {{ $lotAnimal->comment }}</td>
            <td class="unit">{{ $lotAnimal->date_in }}</td>
            <td class="total">{{ $lotAnimal->numAnimals }}</td>
          </tr>
         @endforeach
        </tbody>
