    ...
    <main>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        @foreach($sectors as $sector)
          <tr>
            <td class="no">{{ $sector->id }}</td>
            <td class="desc"><h3>{{ $sector->sector_co }}</h3></td>
            <td class="unit">{{ $sector->sector_de }}</td>
            <td class="total">{{ $sector->numLots }}</td>
          </tr>
         @endforeach
        </tbody>

      </table>
      <div id="thanks">Somos Granja Boraure</div>
      <div id="notices">
