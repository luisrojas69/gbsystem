            ...
            <form class="form-horizontal" 
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" maxlength="2" class="form-control" name="sector_co" id="sector_co" placeholder="Codigo del Sector" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="sector_de" id="sector_de" placeholder="Descripcion del Sector" required>
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
